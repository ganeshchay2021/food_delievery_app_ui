...
List<FoodModel> foodProduct = [
  FoodModel(
    imageCard: 'assets/images/beef_burger.png',
    imageDetail: 'assets/images/beef_burger1.png',
    name: 'Beef Burger',
    price: 7.59,
    rate: 4.5,
  ...
  FoodModel(
    imageCard: 'assets/images/double_burger.png',
    imageDetail: 'assets/images/double_burger1.png',
    name: 'Double Burger',
    price: 10.0,
    rate: 4.9,
  ...
  FoodModel(
    imageCard: 'assets/images/cheese-burger.png',
    imageDetail: 'assets/images/cheese-burger1.png',
    name: 'Cheese Burger',
    price: 8.88,
    rate: 4.8,
  ...
  FoodModel(
    imageCard: 'assets/images/bacon_burger.png',
    imageDetail: 'assets/images/bacon_burger1.png',
    name: 'Bacon Burger',
    price: 9.99,
    rate: 5.0,
  ...
  FoodModel(
    imageCard: 'assets/images/pizza11.png',
    imageDetail: 'assets/images/pizza.png',
    name: 'Chicken Pizza',
    price: 19.99,
    rate: 4.0,
   ...
   FoodModel(
    imageCard: 'assets/images/cup_cake.png',
    imageDetail: 'assets/images/cup-cake1.png',
    name: 'Cream Cake',
    price: 5.99,
    rate: 4.7,
